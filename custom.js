...
function formatRepo1(repo) {
    ...
    var markup = "<div class='select2-result-repository clearfix'>" +
        "<div class='select2-result-repository__meta'>" +
        "<div class='select2-result-repository__title'>" + (repo.zipcode || repo.text) + "</div>";
...
function searchable_cities() {
    var search_zipcodes = $(".search_cities").select2({
        ajax: {
...
$(document).on('click', '.delete_bank', function () {
    var value = $(this).data('id');
    var url = base_url + 'admin/Bank_name/delete_bank_name';
    Swal.fire({
        title: 'Are You Sure !',
        text: "You won't be able to revert this!",
        type: 'warning',
...
$(document).on('click', '#delete-subscription', function () {
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: base_url + 'admin/Subscription/delete_subscription',
                    type: 'GET',
                    data: {
                        'id': id
                    }, 
...
$(document).on('click', '#delete-subscription-history', function () {
    var id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure !',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: base_url + 'admin/Subscription_history/delete_subscription',
                    type: 'GET',
                    data: {
                        'id': id
                    }, 
...
$(document).on('click', '#delete-promation', function () {
    var id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure !',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: base_url + 'admin/Promation/delete_subscription',
                    type: 'GET',
                    data: {
                        'id': id
                    }, 
...
// $(document).on('click', '#display-promation-campain', function () {
//     var seller_id = $(this).data('seller_id');
//     var p_id1 = $(this).data('p_id1');
//     var p_id2 = $(this).data('p_id2');
//     var p_id3 = $(this).data('p_id3');
//     // Swal.fire({
//     //     title: 'Are You Sure !',
//     //     text: "You won't be able to revert this!",
//     //     type: 'warning',
...
//             return new Promise((resolve, reject) => {
//                 $.ajax({
//                     url: base_url + 'admin/promation/view_campain_product',
//                     type: 'GET',
//                     data: {
//                         'seller_id': seller_id,
//                         'p_id1' : p_id1,
...
$(document).on('click', '#delete-promation-campain', function () {
    var id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure !',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: base_url + 'admin/Promation_campain/delete_subscription',
                    type: 'GET',
                    data: {
                        'id': id
                    }, 
