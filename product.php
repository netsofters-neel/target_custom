...
<div class="row col mt-3 deliverable_type <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                        ...
                                        <div class="row col mt-3">
                                           ...
                                           <!--<div class="col-md-2 col-xs-6 cod_allowed <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">-->
                                           <!--     <label for="is_consumables_food" class="col-form-label">Is Consumables Food?</label>-->
                                           <!--     <input type="checkbox" name="is_consumables_food" <?= (isset($product_details[0]['is_consumables_food']) && $product_details[0]['is_consumables_food'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Yes" data-off-text="No">-->
                                           <!-- </div>-->
                                        <div class="row col mt-3">
                                                            ...
                                                            <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                <div class="tab-pane fade active show" id="general-settings" role="tabpanel" aria-labelledby="general-settings-tab">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <select name="type" id="product-type" class="form-control product-type" data-placeholder=" Type to search and select type">
                                                                                <option value="simple_product">Select Type</option>
                                                                    ...
                                                                    <div id="product-general-settings">
                                                                        <div id="general_price_section" class="collapse">
                                                                            ...
                                                                            <div class="form-group  simple_stock_management" >
                                                                                <div class="col" style="visibility: hidden;">
                                                                                    <input type="checkbox" name="simple_stock_management_status" class="align-middle simple_stock_management_status"  checked> <span class="align-middle">Enable Stock Management</span>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div id="variant_stock_level" class="collapse">
                                                                        <div class="form-group" style="visibility: hidden;">
                                                                            <div class="col">
                                                                                <input type="checkbox" name="variant_stock_management_status" class="align-middle variant_stock_status"> <span class="align-middle" checked> Enable Stock Management</span>
                                                                            </div>
                                                                        </div>
